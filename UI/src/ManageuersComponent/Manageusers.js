...

{
  userDetails.map((row)=>(
    ...
    { row.status==0 && <a onClick={()=>{manageUserStatus(row._id,"verify")}} ><img src="./assets/img/active.jpg" height="40" width="40" /></a> }

    { row.status==1 && <a onClick={()=>{manageUserStatus(row._id,"block")}} ><img src="./assets/img/inactive.jpg" height="40" width="40" /></a>}
